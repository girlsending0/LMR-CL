...
class KemDY20:
    def __init__(self, config): 
        ...
        try:
            self.train = load_pickle(DATA_PATH + '/train_wav_20_deploy.pkl')
            self.test = load_pickle(DATA_PATH + '/test_wav_20_deploy.pkl')
            ...
            train_labels = train_data_df.loc[train_data_df['Segment ID'].isin(file_name_pst), ["Total Evaluation_Emotion"]].values
            ...
            test_labels = test_data_df.loc[test_data_df['Segment ID'].isin(file_name_pst), ["Total Evaluation_Emotion"]].values
            ...
            to_pickle(train, DATA_PATH + '/train_wav_20_deploy.pkl')
            ...
            to_pickle(test, DATA_PATH + '/test_wav_20_deploy.pkl')
